...
function Footer() {
  ...
  return (
    <footer className=" bg-gray-100 dark:bg-black py-6 text-center lg:px-19 sm:px-10 px-2  text-[#494949] dark:text-gray-300">
      <ConfigProvider
          theme={{
      ...
      >
          <div className=' flex items-center sm:justify-between sm:gap-0 gap-5 sm:flex-row flex-col justify-center'>
            ...
            <a href='https://www.instagram.com/code_with_adil?igsh=NTc2dTRudnc1ZnYz' target='_blank'><FaInstagram className='hover:text-rose-600 transition-all duration-200'/></a> 
              <a href='https://x.com/AdilPat21587273' target='_blank'><FaXTwitter className=' dark:hover:text-gray-400 hover:text-black transition-all duration-200'/></a>
              ...
              <a href='https://github.com/adil0710' target='_blank'><FaGithub className=' dark:hover:text-gray-400 hover:text-black transition-all duration-200'/></a>
            </div>
      ...
      <Divider/>
        ...
        <div className=' flex items-center justify-center text-md'>
          <p>Developed by</p> <Divider type='vertical' className=' h-5'/> <a className=' font-semibold hover:text-black dark:hover:text-white transition-all duration-200' href='https://adil0710.github.io' target='_blank'>Adil Patel</a>
        </div>
      </ConfigProvider>
  </footer>
  )
